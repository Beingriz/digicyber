                ...
                <div class="middle-container">
                    ...
                    <div class="table-container">
                        <div class="data-table-header">
                            ...
                            <p class="heading">Balance Due Customer Details </p>
                        </div>
                        <div class="table-information">
                                <span class="info-text">Gross Balance Due as on {{ date("d-m-Y") }} is
                               &#x20B9; {{$total_revenue}}</span>
                                <span class="info-text">Applications Found {{$sl_no}}</span>
                                        <div class="row">
                                            <div class="col-25">
...
function SelectService($value) {
    document.location.href = "/digital/cyber/selected_ser_bal_lis/" + $value;
}
</script>
