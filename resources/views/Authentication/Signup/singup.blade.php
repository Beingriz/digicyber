    ...
    <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <form class="text-center" action="{{url('signup')}}" method="POST">
                    @csrf
                    ...
                    <input type="email" id="defaultRegisterFormEmail" name="Email" class="form-control mb-4"
                        placeholder="E-mail"><span class="error">@error('Email'){{$message}}@enderror</span>
                    ...
                    </small><span class="error">@error('Password'){{$message}}@enderror</span>

                    <!-- Phone number -->
                    <input type="number" id="defaultRegisterPhonePassword" name="Phone_No" class="form-control"
                        placeholder="Phone number" aria-describedby="defaultRegisterFormPhoneHelpBlock">
                    <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4">
                        Optional - for two step authentication
                    </small><span class="error">@error('Phone_No'){{$message}}@enderror</span>
